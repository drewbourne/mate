package com.asfusion.mate.actionLists
{
	...
	public class Injectors extends AbstractHandlers
	{
		...
		*/
		...
		//.........................................fireEvent..........................................
		/**
		 * Called by the dispatcher when the event gets triggered.
		...
		*/
		protected function fireEvent(event:InjectorEvent):void
		{
			...
			mapInjections(currentScope);
			runSequence(currentScope, actions);
			unmapInjections(currentScope);
		}
		
		/**
		 * Maps the targets into the IInjector.
		 */
		protected function mapInjections(scope:IScope):void
		{
		}
		
		/**
		 * Unmaps the targets from the IInjector.
		 */
		protected function unmapInjections(scope:IScope):void
		{
		}
