...
package com.asfusion.mate.core
{
	...
	public class EventMap extends EventDispatcher implements IMXMLObject, IEventMap
	{
		...
		*                                      Public Getters (SmartObjects)
		...
		{
			return _dispatcher ||= globalDispatcher;
		}
		 ...
		 * @inheritDoc
		 */
		public function getGlobalDispatcher():IEventDispatcher
		{
		...
		/*-.........................................getGlobalInjector..........................................*/
		protected var globalInjector:IInjector;
		...
		/*-.........................................getInjectorForCache..........................................*/
		/** @inheritDoc */
		public function getInjectorForCache(value:String):IInjector
		{
			if (value === Cache.INHERIT)
			{
				value = (cache === Cache.INHERIT) ? Cache.GLOBAL : cache;
			}
