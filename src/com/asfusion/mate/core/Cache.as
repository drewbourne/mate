...
package com.asfusion.mate.core
{
	...
	public class Cache extends Proxy implements IEventDispatcher, ISmartObject
	{
		 ...
		 */
		public static function addCachedInstance(cacheKey:Class, instance:Object, cacheType:String, scope:IScope):void
		{
		 ...
		 */
		public static function getCachedInstance(cacheKey:Class, cacheType:String, scope:IScope):Object
		{
			var injector:IInjector = scope.eventMap.getInjectorForCache(cacheType);
		...
		public function getValue(scope:IScope, debugCall:Boolean = false):Object
		{
			...
			if (!instance && autoCreate)
			{
				var creator:Creator = new Creator(
					generatorKey,
					scope.dispatcher,
					scope.eventMap.getInjectorForCache(cacheType),
					scope.getLogger());
